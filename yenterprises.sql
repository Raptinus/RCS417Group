...
--
-- Host: localhost
-- Generation Time: Jun 13, 2017 at 11:14 PM
...
INSERT INTO `modification` (`postId`, `modifierId`, `dateModified`) VALUES
(28, 'fidel', '2017-01-12');
...
(28, 'fidel', '2017-06-12', 'we', 'hy', 'asd asdas'),
(29, 'fidel', '2017-06-12', 'dfs', 'sdf', '           '),
(31, 'fidel', '2017-06-13', 'hi sd', 'hi hi', 'sdhidasfas');
...
ALTER TABLE `modification`
  ADD PRIMARY KEY (`postId`,`modifierId`,`dateModified`), ADD KEY `fk_posts_has_users_users1_idx` (`modifierId`), ADD KEY `fk_posts_has_users_posts1_idx` (`postId`);
...
--
ALTER TABLE `modification`
ADD CONSTRAINT `fk_posts_has_users_posts1` FOREIGN KEY (`postId`) REFERENCES `post` (`postId`) ON DELETE CASCADE ON UPDATE NO ACTION,
